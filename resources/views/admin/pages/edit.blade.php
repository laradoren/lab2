                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('admin.pages.update', $page) }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="author" id="inputAuthor" required minlength="5" value="{{ $page->author }}">
                        </div>
                        <div class="form-group">
                            <label for="inputLikes">Likes</label>
                            <input type="number" class="form-control" name="likes" id="inputLikes" required value="{{ $page->likes }}">
                        </div>
                        @csrf
                        {{ method_field('PUT') }}
